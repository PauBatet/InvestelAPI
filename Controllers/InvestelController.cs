...
namespace Investel.Controllers
{
    [Route("api/Vehicles")]
    [ApiController]
    public class InvestelController : ControllerBase
    {
        private readonly InvestelContext _context;

        public InvestelController(InvestelContext context)
        {
            _context = context;
        }
